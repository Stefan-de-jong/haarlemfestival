...
//misschien een idee om in de database een apart tabel aan te maken voor zoekresultaten en voor elke entry een string en page op te halen met als primary key een id? Zou veel code schelen.
...
$page = "historic/about";
if(isset($query)){$search->executeQuery($string, $page, $query);}
