...
<container class="text-center">
    ...
    <section id="main-content" style="position: absolute;background-color: rgb(255,104,104);width: 1154px;margin-top: 63px;height: 916px;margin-left: 384px;">
        ...
        <section>
            ...
            <section style="background-color: #ffffff;margin-top: 0px;width: 464px;margin-left: 66px;"><button class="btn btn-primary" type="button" style="margin-right: 328px;margin-top: 20px;margin-bottom: 20px;"><a class="btn_url" href="<?php echo URLROOT; ?>/pages/dance_purchase">BUY TICKETS</a></button></section>
</form></button></section>
