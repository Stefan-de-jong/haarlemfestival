...
<head>
    ...
    <title>dance_landing_page</title>
...
<body class="text-center">
    <section id="bg-image" style="position: absolute;"><img src="assets/img/bg-left.png" style="position: absolute;"><img style="position: absolute;margin-left: 1536px;" src="assets/img/bg-right.png"></section>
    ...
    <section id="main-content" style="position: absolute;background-color: rgb(255,104,104);width: 1154px;margin-top: 63px;height: 916px;margin-left: 384px;">
        ...
        <section>
            ...
            <section style="background-color: #ffffff;margin-top: 0px;width: 464px;margin-left: 66px;"><button class="btn btn-primary" type="button" style="margin-right: 328px;margin-top: 20px;margin-bottom: 20px;">BUY TICKETS</button></section>
    ...
    <section id="phone"><img src="assets/img/logo.png">
        <h1>Are you on a phone?</h1>
    </section>
    <h3>We do not support mobile devices at this moment in time. We are very sorry for the inconvenience :(<br><br>&nbsp;If you wish to properly view the website on your phone, request the desktop version. You can toggle this on/off in your browser settings.</h3>
    <script
