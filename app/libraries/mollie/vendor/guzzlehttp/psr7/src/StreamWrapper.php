...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5c0568000558c\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5c0568000558c\Psr\Http\Message\StreamInterface $stream)
    {
