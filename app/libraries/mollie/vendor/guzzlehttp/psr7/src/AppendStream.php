 ...
 */
class AppendStream implements \_PhpScoper5c0568000558c\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScoper5c0568000558c\Psr\Http\Message\StreamInterface $stream)
    {
