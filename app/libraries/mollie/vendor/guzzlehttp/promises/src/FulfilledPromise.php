 ...
 */
class FulfilledPromise implements \_PhpScoper5c0568000558c\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \_PhpScoper5c0568000558c\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
